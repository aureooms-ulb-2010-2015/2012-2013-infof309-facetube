...
AddTargetDialog::AddTargetDialog(QWidget *parent) :
    ...
    */
    ...
    this->_hostname->setPlaceholderText("Nom de la cible");
...
QString AddTargetDialog::generateUrl(){
...
void AddTargetDialog::accept(){
    ...
    QString protocol = this->_hostname->text();

    std::string salut = protocol.toUtf8().constData();
